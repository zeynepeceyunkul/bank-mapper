...
public class SourceSchemaServiceTests
{
    ...
    private class FakeMappingRepository : IMappingRepository
    {
        ...
        public Task<(List<Mapping> Items, long TotalCount)> GetPagedAsync(int pageIndex, int pageSize, SortOption sort, string? search = null, MappingStatus? status = null, string? kurumId = null) => Task.FromResult((new List<Mapping>(), 0L));
